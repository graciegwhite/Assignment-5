...
salary_lm <- lm(Salary ~ Sex + Years.Faculty.Service + Years.Since.PhD + Discipline, data = fac_sal_df)
salary_lm
...
salary_lm2 <- lm(Salary ~ Sex + Years.Faculty.Service + Discipline, data = fac_sal_df)
salary_lm2

summary(salary_lm2)

plot(salary_lm2)
#resdiuals look pretty good, and the qq plot looks good. 
