...
employ_graph <- ggplot(phd_med_tidy_employ, aes(x = Field, y = Median.Salary)) +
  ...
  labs(title = "Median Starting Salaries for PhD Recipients in non-PostDoc Positions", x = "Field", y = "Median Salary ($)") +  scale_fill_brewer(palette = "PuBuGn")
...
postdoc_graph <- ggplot(phd_med_tidy_post, aes(x = Field, y = Median.Salary)) +
  ...
  labs(title = "Median Starting Salaries for PhD Recipients in PostDoc Positions", x = "Field", y = "Median Salary ($)") + scale_fill_brewer(palette = "PuBuGn")

postdoc_graph
=======
>>>>>>> eaad95554851abf7be4bccd23ac0624b08548194
```
